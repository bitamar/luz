...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?> <?php print $btn_class; ?>" rel="nofollow"><?php print $link_text; ?><span class="flag-throbber">&nbsp;</span></a>
  <?php else: ?>
