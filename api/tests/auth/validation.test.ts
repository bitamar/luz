...
describe('validation', () => {
  ...
  it('validates claims and email_verified', () => {
    ...
    expect(
      validateClaims({ sub: '1', email: 'e', name: null, picture: null, email_verified: true })
    ).toEqual({
      ok: true,
      data: { sub: '1', email: 'e', name: null, picture: null, email_verified: true },
    });
    expect(
      validateClaims({ sub: '1', email: 'e', name: null, picture: null, email_verified: false })
